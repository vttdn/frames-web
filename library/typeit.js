    ...
    !function(e, t) {
        ...
        return function(e, r={}) {
            let S = async (e, t, n=!1) => {
                ...
                $ = async (e=!0) => {
                    ...
                    try {
                        ...
                        if (!e)
                            return this;
                        if (X.completed = !0, await G.afterComplete(this), !G.loop)
                            throw "";
                        let r = G.loopDelay;
                        S((async () => {
                            await (async e => {
                ...
                let {instant: n} = t,
                    ...
                    i = c(e, G.html).map((e => {
                        return {
                            func: () => z(e),
                            char: e,
                            delay: n || (t = e, /<(.+)>(.*?)<\/(.+)>/.test(t.outerHTML)) ? 0 : M(),
            ...
            this.reset = function(e) {
                ...
                e ? (Y.wipe(), e(this)) : Y.reset(),
                U = 0;
                for (let t in X)
                    X[t] = !1;
                return V[I() ? "value" : "innerHTML"] = "", this
            },
            this.go = function() {
                return X.started ? this : (k(), G.waitUntilVisible ? (((e, t) => {
                ...
                })(V, $.bind(this)), this) : ($(), this))
            },
            this.flush = function(e=(() => {})) {
                return k(), $(!1).then(e), this
            },
            this.getQueue = () => Y,
            this.getOptions = () => G,
            ...
            r.cursor = (e => {
                if ("object" == typeof e) {
                    ...
                    return t.animation = e.animation || {}, t.animation.frames = e.animation?.frames || n, t.animation.options = T(r, e.animation?.options || {}), t.autoPause = e.autoPause ?? l.cursor.autoPause, t.autoPauseDelay = e.autoPauseDelay || l.cursor.autoPauseDelay, t
                }
            ...
            let Z = !!G.cursor && !I(),
                ee = (() => {
                    if (I())
                        return;
                    let e = d("span");
                    return e.className = o, Z ? (e.innerHTML = a(G.cursorChar).innerHTML, e) : (e.style.visibility = "hidden", e)
                })();
            G.strings = (e => {
                let t = V.innerHTML;
                return t ? (V.innerHTML = "", G.startDelete ? (V.innerHTML = t, i(V), F(E({
                    func: j,
                    delay: M(1),
                    deletable: !0
                }, x().length)), e) : t.replace(/<!--(.+?)-->/g, "").trim().split(/<br(?:\s*?)(?:\/)?>/).concat(e)) : e
            })(t(G.strings)),
            G.strings.length && R()
        }
    }));
...
/*
     FILE ARCHIVED ON 18:54:05 Aug 01, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 10:52:26 Jul 08, 2024.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 9.088
  LoadShardBlock: 43.949 (3)
  PetaboxLoader3.datanode: 46.209 (4)
  load_resource: 98.647
  PetaboxLoader3.resolve: 54.578
*/
