...
function shareOn(platform) {
    ...
    // Get description from meta tag (works for all page types)
    const metaDescription = document.querySelector('meta[name="description"]');
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "{{ locale_data.blog.meta.description }}");
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="{{ locale_data.mobile_menu.navigation_aria_label }}">
          <ul class="flex flex-col">
            ...
            <li><a href="{{ lang_config.path }}{{ locale_data.urls.blog }}">{{ locale_data.mobile_menu.blog }}</a></li>
