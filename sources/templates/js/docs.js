// Documentation page JavaScript for Frames website
// Language: {{ lang }}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        ...
        '/lib/schema/{{ lang }}/breadcrumb-docs.json',
        '/lib/schema/{{ lang }}/webpage-docs.json',
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="{{ locale_data.mobile_menu.navigation_aria_label }}">
          <ul class="flex flex-col">
            ...
            <li><a href="{{ lang_config.path }}{{ locale_data.urls.documentation }}">{{ locale_data.mobile_menu.documentation }}</a></li>
