...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/ro/frames.json',
        '/lib/schema/ro/faq.json',
        '/lib/schema/ro/organization.json',
        '/lib/schema/ro/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames este o aplicație fotografie film pentru fotografi analogici. Notează fiecare cadru, urmărește setările camerei, organizează filmele și salvează metadatele EXIF.");
