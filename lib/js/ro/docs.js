const TWITTER_HANDLE="withframes";const VIA_TEXT="via";document.addEventListener('DOMContentLoaded',function(){const schemaFiles=['/lib/schema/ro/organization.json','/lib/schema/ro/breadcrumb-docs.json','/lib/schema/ro/webpage-docs.json','/lib/schema/ro/video.json'];schemaFiles.forEach((url)=>{fetch(url).then(response=>{if(!response.ok){throw new Error(`Failed to fetch ${url}: ${response.status}`);}
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="Navigare mobilă">
          <ul class="flex flex-col">
            ...
            <li><a href="/ro/docs/">Documentație</a></li>
