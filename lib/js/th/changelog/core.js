...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "บันทึกการเปลี่ยนแปลงของ Frames ฟีเจอร์ล่าสุดและการปรับปรุงสำหรับแอปถ่ายภาพฟิล์ม Frames");
