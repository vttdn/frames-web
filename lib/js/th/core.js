...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/th/frames.json',
        '/lib/schema/th/faq.json',
        '/lib/schema/th/organization.json',
        '/lib/schema/th/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames เป็นแอปถ่ายภาพฟิล์มสำหรับช่างภาพอนาล็อก บันทึกทุกภาพ ติดตามการตั้งค่ากล้อง จัดระเบียบฟิล์ม และบันทึกเมตาดาตา EXIF บน iPhone และ Mac");
