...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/tr/frames.json',
        '/lib/schema/tr/faq.json',
        '/lib/schema/tr/organization.json',
        '/lib/schema/tr/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames analog fotoğrafçılar için film fotoğrafçılığı uygulamasıdır. Her çekimi kaydedin, kamera ayarlarını takip edin, rulolarınızı düzenleyin ve iPhone & Mac'te EXIF metadata kaydedin.");
