...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/id/frames.json',
        '/lib/schema/id/faq.json',
        '/lib/schema/id/organization.json',
        '/lib/schema/id/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames adalah aplikasi fotografi film untuk fotografer analog. Catat setiap foto, lacak pengaturan kamera, atur rol film, dan simpan metadata EXIF di iPhone & Mac.");
