const TWITTER_HANDLE="withframes";const VIA_TEXT="via";document.addEventListener('DOMContentLoaded',function(){const schemaFiles=['/lib/schema/id/organization.json','/lib/schema/id/breadcrumb-docs.json','/lib/schema/id/webpage-docs.json','/lib/schema/id/video.json'];schemaFiles.forEach((url)=>{fetch(url).then(response=>{if(!response.ok){throw new Error(`Failed to fetch ${url}: ${response.status}`);}
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="Navigasi mobile">
          <ul class="flex flex-col">
            ...
            <li><a href="/id/docs/">Dokumentasi</a></li>
