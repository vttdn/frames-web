...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/uk/frames.json',
        '/lib/schema/uk/faq.json',
        '/lib/schema/uk/organization.json',
        '/lib/schema/uk/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames – додаток плівкової фотографії для аналогових фотографів. Записуйте кожен кадр, відстежуйте налаштування камери, організовуйте плівки та зберігайте EXIF.");
