...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Історія змін Frames, додатка для плівкової фотографії – останні функції та покращення.");
