...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/hi/frames.json',
        '/lib/schema/hi/faq.json',
        '/lib/schema/hi/organization.json',
        '/lib/schema/hi/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames फ़िल्म फ़ोटोग्राफ़रों के लिए ऐप है। हर शॉट लॉग करें, कैमरा सेटिंग्स ट्रैक करें, रोल्स व्यवस्थित करें और iPhone व Mac पर EXIF मेटाडेटा सहेजें।");
