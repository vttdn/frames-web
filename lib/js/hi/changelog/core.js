...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames के लिए परिवर्तन सूची, फ़िल्म फ़ोटोग्राफ़ी ऐप Frames में नवीनतम सुविधाएं और सुधार।");
