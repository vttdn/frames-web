...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog Frames. Bądź na bieżąco z najnowszymi funkcjami i ulepszeniami Frames, aplikacji do fotografii analogowej.");
