...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames changelog. Håll dig uppdaterad med de senaste funktionerna och förbättringarna för Frames, appen för filmfotografi.");
