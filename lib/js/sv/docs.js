const TWITTER_HANDLE="withframes";const VIA_TEXT="via";document.addEventListener('DOMContentLoaded',function(){const schemaFiles=['/lib/schema/sv/organization.json','/lib/schema/sv/breadcrumb-docs.json','/lib/schema/sv/webpage-docs.json','/lib/schema/sv/video.json'];schemaFiles.forEach((url)=>{fetch(url).then(response=>{if(!response.ok){throw new Error(`Failed to fetch ${url}: ${response.status}`);}
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="Mobilnavigering">
          <ul class="flex flex-col">
            ...
            <li><a href="/sv/docs/">Dokumentation</a></li>
