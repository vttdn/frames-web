...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog do Frames. Mantenha-se atualizado com as últimas funcionalidades e melhorias da app de fotografia analógica.");
