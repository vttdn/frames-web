...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog do Frames. Mantenha-se atualizado com as últimas funcionalidades e melhorias do Frames, a app de fotografia analógica.");
