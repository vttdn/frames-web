...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/pt/frames.json',
        '/lib/schema/pt/faq.json',
        '/lib/schema/pt/organization.json',
        '/lib/schema/pt/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames é uma app de fotografia analógica. Registe cada exposição, acompanhe definições, organize rolos e guarde metadados EXIF no iPhone & Mac.");
