...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames is a film photography app for analog photographers. Log every shot, track camera settings, organize rolls, and save EXIF metadata on iPhone & Mac.");
