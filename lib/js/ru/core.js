...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/ru/frames.json',
        '/lib/schema/ru/faq.json',
        '/lib/schema/ru/organization.json',
        '/lib/schema/ru/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames – приложение для плёночной фотографии. Фиксируйте каждый кадр, отслеживайте настройки камеры, упорядочивайте плёнки и сохраняйте метаданные на iPhone и Mac.");
