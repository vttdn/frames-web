...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Обновления Frames, приложения для плёночной фотографии – последние функции и улучшения.");
