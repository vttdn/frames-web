...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames Changelog. Bleiben Sie über die neuesten Funktionen und Verbesserungen der Analogfotografie-App informiert.");
