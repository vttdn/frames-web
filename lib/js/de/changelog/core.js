...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames Changelog. Bleiben Sie über die neuesten Funktionen und Verbesserungen für Frames informiert, die App für Analogfotografie.");
