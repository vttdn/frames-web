...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/de/frames.json',
        '/lib/schema/de/faq.json',
        '/lib/schema/de/organization.json',
        '/lib/schema/de/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames ist die Analogfotografie-App für Film-Fotografen. Aufnahmen dokumentieren, Einstellungen tracken, Filme organisieren und EXIF-Metadaten speichern.");
