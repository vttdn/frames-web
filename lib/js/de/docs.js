const TWITTER_HANDLE="withframes";const VIA_TEXT="via";document.addEventListener('DOMContentLoaded',function(){const schemaFiles=['/lib/schema/de/organization.json','/lib/schema/de/breadcrumb-docs.json','/lib/schema/de/webpage-docs.json','/lib/schema/de/video.json'];schemaFiles.forEach((url)=>{fetch(url).then(response=>{if(!response.ok){throw new Error(`Failed to fetch ${url}: ${response.status}`);}
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="Mobile Navigation">
          <ul class="flex flex-col">
            ...
            <li><a href="/de/docs/">Dokumentation</a></li>
