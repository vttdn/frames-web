...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames changelog. Blijf op de hoogte van de nieuwste functies en verbeteringen voor de analoge fotografie-app.");
