...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog de Frames. Restez informé des dernières fonctionnalités et améliorations de Frames, l'application de photographie argentique.");
