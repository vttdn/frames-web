...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const isEntryPage = path.match(/\/changelog\/[^/]+\/?$/);
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog de Frames. Restez informé des dernières fonctionnalités et améliorations de l'application de photographie argentique.");
