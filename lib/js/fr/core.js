...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/fr/frames.json',
        '/lib/schema/fr/faq.json',
        '/lib/schema/fr/organization.json',
        '/lib/schema/fr/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames est une application photo argentique. Enregistrez chaque prise, suivez les réglages, organisez vos pellicules et sauvegardez les métadonnées EXIF sur iPhone & Mac.");
