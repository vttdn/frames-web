...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog de Frames. Mantente al día con las últimas funciones y mejoras de la app de fotografía analógica.");
