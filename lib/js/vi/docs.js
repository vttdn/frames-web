const TWITTER_HANDLE="withframes";const VIA_TEXT="via";document.addEventListener('DOMContentLoaded',function(){const schemaFiles=['/lib/schema/vi/organization.json','/lib/schema/vi/breadcrumb-docs.json','/lib/schema/vi/webpage-docs.json','/lib/schema/vi/video.json'];schemaFiles.forEach((url)=>{fetch(url).then(response=>{if(!response.ok){throw new Error(`Failed to fetch ${url}: ${response.status}`);}
      ...
      <div class="wrapper">
        ...
        <nav class="mobile-menu-nav" aria-label="Điều hướng di động">
          <ul class="flex flex-col">
            ...
            <li><a href="/vi/docs/">Tài Liệu</a></li>
