...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/el/frames.json',
        '/lib/schema/el/faq.json',
        '/lib/schema/el/organization.json',
        '/lib/schema/el/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Το Frames είναι εφαρμογή φωτογραφίας φιλμ. Καταγράψτε κάθε λήψη, παρακολουθήστε ρυθμίσεις, οργανώστε φιλμ και αποθηκεύστε μεταδεδομένα EXIF στο iPhone & Mac.");
