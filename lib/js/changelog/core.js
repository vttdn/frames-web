...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Frames changelog. Stay updated with the latest features and improvements for the film photography app.");
