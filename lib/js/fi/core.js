...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/fi/frames.json',
        '/lib/schema/fi/faq.json',
        '/lib/schema/fi/organization.json',
        '/lib/schema/fi/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames on filmivalokuvaussovellus analogisille valokuvaajille. Kirjaa jokainen kuva, seuraa kamera-asetuksia, järjestä filmit ja tallenna EXIF-metatiedot.");
