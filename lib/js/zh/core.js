...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/zh/frames.json',
        '/lib/schema/zh/faq.json',
        '/lib/schema/zh/organization.json',
        '/lib/schema/zh/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames 是为胶片摄影师设计的应用。记录每张照片，追踪相机设置，整理胶卷，在 iPhone 和 Mac 上保存 EXIF 元数据。");
