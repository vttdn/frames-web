...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/it/frames.json',
        '/lib/schema/it/faq.json',
        '/lib/schema/it/organization.json',
        '/lib/schema/it/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames è un'app fotografia analogica. Registra ogni scatto, monitora le impostazioni, organizza i rullini e salva i metadati EXIF su iPhone & Mac.");
