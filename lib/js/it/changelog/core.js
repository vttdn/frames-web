...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog di Frames. Rimani aggiornato sulle ultime funzionalità e miglioramenti dell'app di fotografia analogica.");
