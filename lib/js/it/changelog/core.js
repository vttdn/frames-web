...
function shareOn(platform) {
    ...
    const text = encodeURIComponent(metaDescription ? metaDescription.getAttribute('content') : "Changelog di Frames. Rimani aggiornato sulle ultime funzionalità e miglioramenti di Frames, l'app di fotografia analogica.");
