...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const schemaFiles = [
        '/lib/schema/zh-hant/frames.json',
        '/lib/schema/zh-hant/faq.json',
        '/lib/schema/zh-hant/organization.json',
        '/lib/schema/zh-hant/webpage-homepage.json'
    ];
...
function shareOn(platform) {
    ...
    const text = encodeURIComponent("Frames 是為膠片攝影師設計的應用。記錄每張照片，追蹤相機設定，整理膠卷，在 iPhone 和 Mac 上保存 EXIF 元資料。");
